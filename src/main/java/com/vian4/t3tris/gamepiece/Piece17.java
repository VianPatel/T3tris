...
public class Piece17 extends GamePiece {

    public Piece17(GameBoard gameBoard, ColorRGBA color, int x, int y, int z) {
    ...
    protected Point[] initPoints(int x, int y, int z) {
        ...
        points[2] = new Point(x, y - 1, z);
        points[3] = new Point(x, y - 1, z + 1);
        points[4] = new Point(x, y - 2, z);
        return points;
    }
