...
public class Piece12 extends GamePiece {

    public Piece12(GameBoard gameBoard, ColorRGBA color, int x, int y, int z) {
    ...
    protected Point[] initPoints(int x, int y, int z) {
        ...
        points[3] = new Point(x + 2, y - 1, z);
        points[4] = new Point(x + 2, y - 2, z);
        return points;
    }
